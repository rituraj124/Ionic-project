...
import { IonButtons, IonContent, IonHeader, IonThumbnail, IonTitle, IonToolbar, IonIcon, IonRow, IonCol,IonText, IonLabel, IonSearchbar, IonButton, IonList, IonListHeader } from '@ionic/angular/standalone';
